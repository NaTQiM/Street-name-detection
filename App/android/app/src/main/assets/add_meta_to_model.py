...
class MetadataPopulatorForImageClassifier(object):
    ...
    def _create_metadata(self):
        ...
        model_meta.description = "TOCO Converted. Identify which of a known set of objects might be present and " \
                                 "provide information about their positions within the given image or a video  stream. "
        ...
        output_location_meta.content.content_properties = _metadata_fb.ContentT()
